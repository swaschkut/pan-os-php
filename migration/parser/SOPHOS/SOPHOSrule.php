...
trait SOPHOSrule
{
    ...
    public function rule_noRulesort($master_array)
    {
        ...
        if( isset($master_array['packetfilter']) )
        {
            ...
            foreach( $master_array['packetfilter'] as $policy )
            {
                ...
                elseif( $rule_type === "packetfilter/nat" || $rule_type === "packetfilter/masq" )
                {
                    $tmp_rule = $this->sub->natRules->newNATRule($rule_name);
                    PH::print_stdout( PH::boldText("generate new NAT Rule:" . $rule_name) );
                    continue;
                }
