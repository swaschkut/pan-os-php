...
// Additional tax / fees input (Default: 22.21 cents)
$taxInput = isset($_GET['tax']) ? str_replace(',', '.', $_GET['tax']) : '22.21';
$taxAddOn = (float)$taxInput;
...
// Helper function: standard 15-minute resolution with tax addition
...
<div class="container">
    ...
    <div class="controls-wrapper">
        <form method="GET" action="<?php echo $currentScript; ?>">
            ...
            <div class="form-group">
                <label for="tax">Tax/Fees Add-On (ct/kWh):</label>
