...
RQuery::$defaultFilters['profile']['refcount']['operators']['>,<,=,!'] = array(
...
RQuery::$defaultFilters['profile']['object']['operators']['is.unused'] = array(
...
/*
RQuery::$defaultFilters['profile']['object']['operators']['is.expired'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['object']['operators']['expire.in.days'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $value = $context->object;
...
*/
RQuery::$defaultFilters['profile']['name']['operators']['is.in.file'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['object']['operators']['is.tmp'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['name']['operators']['eq'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['name']['operators']['eq.nocase'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['name']['operators']['contains'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['name']['operators']['regex'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $object = $context->object;
        $value = $context->value;
...
RQuery::$defaultFilters['profile']['location']['operators']['is'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['location']['operators']['regex'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['location']['operators']['is.child.of'] = array(
    'Function' => function (EDLRQueryContext $context) {
...
RQuery::$defaultFilters['profile']['location']['operators']['is.parent.of'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $edl_location = $context->object->getLocationString();
...
RQuery::$defaultFilters['profile']['reflocation']['operators']['is'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $object = $context->object;
        $owner = $context->object->owner->owner;
...
RQuery::$defaultFilters['profile']['reflocation']['operators']['is.only'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $owner = $context->object->owner->owner;
...
RQuery::$defaultFilters['profile']['refstore']['operators']['is'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $value = $context->value;
...
RQuery::$defaultFilters['profile']['reftype']['operators']['is'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $value = $context->value;
        $value = strtolower($value);
...
RQuery::$defaultFilters['profile']['expire.in.days']['operators']['>,<,=,!'] = array(
    'Function' => function (EDLRQueryContext $context) {
        $value = $context->object;
